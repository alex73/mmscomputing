...
public class CapiIOException extends CapiException{

  private int errno=0;

  public CapiIOException(int errno){
    super("\n"+capiInfo2Str(errno));
    this.errno=errno;
  }
  ...
  public static String capiInfo2Str(int reason){
    switch (reason) {

/*-- mmsc jcapi values --*/
    case -6: return "Unrecoverable network error.";
    case -5: return "Do not call 32 bit function in 64 bit environment.";
    case -4: return "Do not call 64 bit function in 32 bit environment.";
    case -3: return "No Capi Serial Number available!";
    case -2: return "No Capi Version Information available!";
    case -1: return "No Capi Manufacturer Information available!";
...
/*-- disconnect causes from the network according to ETS 300 102-1/Q.931 -----*/
  	...
  	case 0x3410: return "Normal call clearing";			//	DSS1
	  case 0x3411: return "User busy";				//	DSS1
  	case 0x3412: return "No user responding";			//	DSS1
	  case 0x3415: return "Call rejected";				//	DSS1

	  case 0x3460: return "Mandatory information element is missing";
	  case 0x3461: return "Message type nonexistent or not implemented";
	  case 0x3462: return "Message not compatible with call state or message type nonexistent or not implemented";
	  case 0x3463: return "Information element nonexistent or not implemented";
	  case 0x3464: return "Invalid information element contents";
	  case 0x3465: return "Message not compatible with call state";
	  case 0x3466: return "Recovery on timer expiry";
	  case 0x346F: return "Protocol error, unspecified";
	  ...
	  case 0x350D: return "No connect (timeout or wrong modulation)";
  	...
  	default: return "No additional information available for capi reason = 0x"+Integer.toHexString(reason);
    }
  }
}