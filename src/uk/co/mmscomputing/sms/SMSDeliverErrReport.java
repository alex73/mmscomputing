...
public class SMSDeliverErrReport extends SMSErrReport{

  public SMSDeliverErrReport(int err){setErrorCode(err);}

  public SMSDeliverErrReport(InputStream in)throws IOException{
    readFrom(in);
  }
