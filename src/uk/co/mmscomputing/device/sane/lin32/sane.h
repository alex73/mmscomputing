...
typedef SANE_Status                   (*psane_init)                 (SANE_Int * version_code,SANE_Auth_Callback authorize);
typedef void                          (*psane_exit)                 (void);
typedef SANE_Status                   (*psane_get_devices)          (const SANE_Device *** device_list,SANE_Bool local_only);
typedef SANE_Status                   (*psane_open)                 (SANE_String_Const devicename,SANE_Handle * handle);
typedef void                          (*psane_close)                (SANE_Handle handle);
typedef const SANE_Option_Descriptor* (*psane_get_option_descriptor)(SANE_Handle handle, SANE_Int option);
typedef SANE_Status                   (*psane_control_option)       (SANE_Handle handle, SANE_Int option,SANE_Action action, void *value,SANE_Int * info);
typedef SANE_Status                   (*psane_get_parameters)       (SANE_Handle handle,SANE_Parameters * params);
typedef SANE_Status                   (*psane_start)                (SANE_Handle handle);
typedef SANE_Status                   (*psane_read)                 (SANE_Handle handle, SANE_Byte * data,SANE_Int max_length, SANE_Int * length);
typedef void                          (*psane_cancel)               (SANE_Handle handle);
typedef SANE_Status                   (*psane_set_io_mode)          (SANE_Handle handle,SANE_Bool non_blocking);
typedef SANE_Status                   (*psane_get_select_fd)        (SANE_Handle handle,SANE_Int * fd);
typedef SANE_String_Const             (*psane_strstatus)            (SANE_Status status);

extern psane_init                   sane_init;
extern psane_exit                   sane_exit;
extern psane_get_devices            sane_get_devices;
extern psane_open                   sane_open;
extern psane_close                  sane_close;
extern psane_get_option_descriptor  sane_get_option_descriptor;
extern psane_control_option         sane_control_option;
extern psane_get_parameters         sane_get_parameters;
extern psane_start                  sane_start;
extern psane_read                   sane_read;
extern psane_cancel                 sane_cancel;
extern psane_set_io_mode            sane_set_io_mode;
extern psane_get_select_fd          sane_get_select_fd;
extern psane_strstatus              sane_strstatus;
